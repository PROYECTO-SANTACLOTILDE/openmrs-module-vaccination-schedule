...
public class PatientVaccinationStatus {
	...
	public String toString() {
		return "PatientVaccinationStatus{" + "patient=" + (patient != null ? patient.getPatientId() : "null")
		        + ", vaccineName='" + getVaccineName() + '\'' + ", doseNumber=" + getDoseNumber() + ", status=" + status
		        + ", dueDate=" + dueDate + ", appliedDate=" + appliedDate + '}';
	}
}
